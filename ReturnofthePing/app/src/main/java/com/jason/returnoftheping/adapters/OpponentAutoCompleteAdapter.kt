 ...
 */
private class OpponentAutoCompleteAdapter(context: Context, private var mOpponents: List<Player>) : ArrayAdapter<Player>(context, LAYOUT_RES_ID, mOpponents), Filterable {
